...
export default class RegistrationForm {
    ...
    events() {
        ...
        // Blur runs when you exit off a field, or when it loses focus
    ...
    usernameImmediately() {
        if(this.username.value != "" && !/^([a-zA-Z0-9]+)$/.test(this.username.value)) {
            this.showValidationError(this.username, "Username can only contain alphanumeric characters.")
        }
    ...
    emailHandler() {
        ...
        this.email.timer = setTimeout(() => this.emailAfterDelay(), 2500)
    }
